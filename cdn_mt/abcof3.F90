...
#include "cpp_double.h"
      ...
      COMPLEX, INTENT(OUT):: a(band_l:, 0:, :)!(lapw%dim_nvd(),0:atoms%lmaxd*(atoms%lmaxd+2),atoms%nat)
      COMPLEX, INTENT(OUT):: b(band_l:, 0:, :)!(lapw%dim_nvd(),0:atoms%lmaxd*(atoms%lmaxd+2),atoms%nat)
