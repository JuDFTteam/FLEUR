                      ...
                      DO nn = 1,atoms%neq(ntyp)
                         ...
                         DO i = 1,ne
                            ...
                            denCoeffs%acnmt(lp,lo,lh,ntyp,ispin) = denCoeffs%acnmt(lp,lo,lh,ntyp,ispin) +&
                                                                   we(i) * REAL(cf1 * CONJG(eigVecCoeffs%abcof(i,lmp,0,na,ispin)) )
                            denCoeffs%bcnmt(lp,lo,lh,ntyp,ispin) = denCoeffs%bcnmt(lp,lo,lh,ntyp,ispin) +&
                                                                   we(i) * REAL(cf1 * CONJG(eigVecCoeffs%abcof(i,lmp,1,na,ispin)) )
                         END DO
                      END DO
                   END DO
                   ...
                   DO lp = lpmin,lpmax,2
                      ...
                      DO nn = 1,atoms%neq(ntyp)
                         ...
                         DO i = 1,ne
                            ...
                            denCoeffs%acnmt(lp,lo,lh,ntyp,ispin) = denCoeffs%acnmt(lp,lo,lh,ntyp,ispin) +&
                                                                   we(i) * REAL(cf1 * eigVecCoeffs%abcof(i,lmp,0,na,ispin) )
                            denCoeffs%bcnmt(lp,lo,lh,ntyp,ispin) = denCoeffs%bcnmt(lp,lo,lh,ntyp,ispin) +&
                                                                   we(i) * REAL(cf1 * eigVecCoeffs%abcof(i,lmp,1,na,ispin) )
                         END DO
                      END DO
                   END DO
