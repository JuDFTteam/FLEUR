...
if (${CMAKE_Fortran_COMPILER_ID} MATCHES "Intel")
   ...
   if (${CMAKE_Fortran_COMPILER_VERSION} VERSION_LESS "19.0.0.0")
       ...
       set(CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_DEBUG} -check arg_temp_created,assume,bounds,contiguous,format,output_conversion,pointers,stack,uninit -traceback -O0 -g -ftrapuv -check uninit -check pointers -DCPP_DEBUG")
   endif()
