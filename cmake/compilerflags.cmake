...
if (CMAKE_Fortran_COMPILER_ID MATCHES "Intel")
   ...
   set(CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_Fortran_FLAGS_RELEASE} -axavx2 -O2 -g -fPIC ")
...
elseif (CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC")
  set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS}  -tp=host -mp  -O3 -g -fPIC")
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fPIC ")
  set(FLEUR_COMPILE_OPTIONS -Mlre -Mautoinline -Mvect=simd -Mcache_align -Mflushz -O3 -g)
#old line:
...
elseif (CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
   if (CMAKE_Fortran_COMPILER_VERSION VERSION_LESS "13.0")
      message(FATAL_ERROR "Only modern versions of gfortran >13 will be able to compile FLEUR\nYou need to specify a different compiler.\nSee the docs at www.flapw.de.\n")
   endif()
