...
if (__check_external)
   ...
   #Only External ELPA
    ...
    if (FLEUR_USE_ELPA)
        set(FLEUR_PARALLEL_DEFINITIONS ${FLEUR_PARALLEL_DEFINITIONS} "CPP_ELPA")
    endif()
    ...
    if (FLEUR_USE_ELPA)
        ...
        if (FLEUR_USE_ELPA_PATCH)
                ...
                set(FLEUR_PARALLEL_DEFINITIONS ${FLEUR_PARALLEL_DEFINITIONS} "CPP_ELPA_PATCH")
        endif()
        ...
        if (FLEUR_USE_ELPA_SP)
                ...
                set(FLEUR_PARALLEL_DEFINITIONS ${FLEUR_PARALLEL_DEFINITIONS} "CPP_ELPA_SP")
        endif()
    endif()    
