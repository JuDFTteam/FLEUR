! The contents of the test program are taken from one of the examples
! of the SpFFT library. This was done with permission by the SpFFT
! developers. Thank you for that! - G.M.
