...
#ifdef CPP_REALDATA
       call geneigprobl(lapw%nv(jsp)-nred+oddlocs, lapw%nv(jsp)-nred+oddlocs,iu,jij%l_j,etemp2,ne2,a,b,z2)
#else
       call geneigprobl(lapw%nv(jsp)-nred+oddlocs, lapw%nv(jsp)-nred+oddlocs,iu,jij%l_j,etemp2,ne2,a_c=a,b_c=b,z_c=z2)
#endif
       if(l_verbose)then   
...
#ifdef CPP_REALDATA
       call geneigprobl(nred+evenlocs, nred+evenlocs,iu,jij%l_j,etemp1,ne1,aa,bb,z1)
#else
       call geneigprobl(nred+evenlocs, nred+evenlocs,iu,jij%l_j,etemp1,ne1,a_c=aa,b_c=bb,z_c=z1)
#endif
       if(l_verbose)then
