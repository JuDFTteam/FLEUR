         ...
         DO lo = 1,atoms%nlo(ntyp)
            ...
            DO m = -l,l
               ...
               IF (.TRUE.) THEN
                  ...
                  tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin)=tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin) + &
                        + 0.5 * usdus%uulon(lo,ntyp,iSpinPr) &
                        * ( enpara%el0(l,ntyp,iSpinPr)+enpara%ello0(lo,ntyp,iSpinPr) )
                  tlmplm%tdulo(lm,m,lo+mlo,iSpinPr,iSpin) = tlmplm%tdulo(lm,m,lo+mlo,iSpinPr,iSpin) &
                      ...
                      * ( enpara%el0(l,ntyp,iSpinPr)+enpara%ello0(lo,ntyp,iSpinPr) ) &
                      + 0.5 * usdus%uulon(lo,ntyp,iSpinPr)
                      tlmplm%h_LO(lmp+s,m,lo+mlo,iSpinPr,iSpin)=tlmplm%h_LO(lmp+s,m,lo+mlo,iSpinPr,iSpin) + &
                      + 0.5 * usdus%dulon(lo,ntyp,iSpinPr) &
                      * ( enpara%el0(l,ntyp,iSpinPr)+enpara%ello0(lo,ntyp,iSpinPr) ) &
                      + 0.5 * usdus%uulon(lo,ntyp,iSpinPr)
                  ...
                  IF (atoms%ulo_der(lo,ntyp).GE.1) THEN
                     ...
                     tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin)=tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin) + 0.5 * usdus%uuilon(lo,ntyp,iSpinPr)
                     tlmplm%h_LO(lmp+s,m,lo+mlo,iSpinPr,iSpin)=tlmplm%h_LO(lmp+s,m,lo+mlo,iSpinPr,iSpin) + 0.5 * usdus%duilon(lo,ntyp,iSpinPr)
                  ...
                  IF (atoms%l_dulo(lo,ntyp)) THEN
                     tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin)=tlmplm%h_LO(lmp,m,lo+mlo,iSpinPr,iSpin) + 0.5
                     tlmplm%tuulo(lm,m,lo+mlo,iSpinPr,iSpin) = tlmplm%tuulo(lm,m,lo+mlo,iSpinPr,iSpin) + 0.5
                     tlmplm%h_LO(lmp+s,m,lo+mlo,iSpinPr,iSpin)= 0.0
