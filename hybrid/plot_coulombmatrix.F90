    ...
    IF (l_plot) THEN
       ...
       DO ikpt = 1, kpts%nkpt
                ...
                DO l = 0, hybinp%lcutm1(itype)
                   DO M = -l, l
                      ...
                      DO n = 1, mpdata%num_radbasfn(l, itype)
                         WRITE (700 + ikpt, '(16f8.4)') coulhlp(ic + n, ic + 1:ic + mpdata%num_radbasfn(l, itype))
                      END DO
                      ic = ic + mpdata%num_radbasfn(l, itype)
                   ENDDO
                END DO
             END DO
          END DO
                   ...
                   DO M = -l, l
                      DO n = 1, mpdata%num_radbasfn(l, itype) - 1
                         coulhlp1(ic + n, ic + 1:ic + mpdata%num_radbasfn(l, itype) - 1) &
                            = coulhlp(ic1 + n, ic1 + 1:ic1 + mpdata%num_radbasfn(l, itype) - 1)
                      END DO

                      coulhlp1(ic2 + 1, ic + 1:ic + mpdata%num_radbasfn(l, itype) - 1) &
                         = coulhlp(ic1 + mpdata%num_radbasfn(l, itype), ic1 + 1:ic1 + mpdata%num_radbasfn(l, itype) - 1)

                      ic = ic + mpdata%num_radbasfn(l, itype) - 1
                      ic1 = ic1 + mpdata%num_radbasfn(l, itype)
                      ic2 = ic2 + 1
          ...
          IF (ikpt == 1) THEN
             ...
             DO itype = 1, atoms%ntype
                DO ineq = 1, atoms%neq(itype)
                   WRITE (*, *) ic + 1, ic + mpdata%num_radbasfn(0, itype) - 1, ic1 + 1, &
                      ic1 + mpdata%num_radbasfn(0, itype) - 1
                   coulhlp1(ic + 1:ic + mpdata%num_radbasfn(0, itype) - 1, nbasp + 1) &
                      = coulhlp(ic1 + 1:ic1 + mpdata%num_radbasfn(0, itype) - 1, nbasp + 1)
                      ...
                      DO M = -l, l
                         ...
                         DO itype1 = 1, atoms%ntype
                            ...
                            DO ineq1 = 1, atoms%neq(itype1)
                               ...
                               ic8 = ic7 + mpdata%num_radbasfn(0, itype1) - 2
             ...
             DO ineq = 1, atoms%neq(itype)
                DO l = 0, hybinp%lcutm1(itype)
                   ...
                   DO M = -l, l
                      WRITE (800 + ikpt, *) l, M
                      DO n = 1, mpdata%num_radbasfn(l, itype) - 1
                         WRITE (800 + ikpt, '(16f8.4)') coulhlp1(ic + n, ic + 1:ic + mpdata%num_radbasfn(l, itype) - 1)
                      END DO
                      ic = ic + mpdata%num_radbasfn(l, itype) - 1
                   ENDDO
                END DO
