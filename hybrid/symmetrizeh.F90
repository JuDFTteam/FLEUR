      ...
      !
      ! symmetrize the Hamiltonian according to the symmetry operations
      ! of the little group of k
      !
      CONTAINS

        SUBROUTINE symmetrizeh(atoms,&
                   ...
                   DO ieq = 1,atoms%neq(itype)
                      ...
                      IF( atoms%invsat(iatom) .EQ. 0 .OR. atoms%invsat(iatom) .EQ. 1 ) THEN
                         ...
                         DO ilo = 1,atoms%nlo(itype)
                            ...
                            !                   WRITE(400,*) 'isym,ratom,ilo',isym,ratom,ilo
                            !                   WRITE(400,*) c_rot(:idum,:idum,ilo,ratom,isym)
                            DEALLOCATE( ipiv,y )
                         END DO
                         ...
                         DO igpt = 1,invsfct*(2*l+1)
                            ...
                            DO j = 1,lapw%nv(jsp)
                               ...
                               DO isym = 1,nsymop
                                  ...
                                  !                       WRITE(600,*) 'j,igpt1',j,pointer_apw(j,isym)
                                  ic    = ic + 1
                                  iop   = psym(isym)
                                  ratom = map(isym,iatom)
                ...
                DO ieq = 1,atoms%neq(itype)
                   ...
                   IF( atoms%invsat(iatom) .EQ. 0 .OR. atoms%invsat(iatom) .EQ. 1 ) THEN
                      ...
                      DO ilo = 1,atoms%nlo(itype)
                         ...
                         DO igpt = 1,invsfct*(2*l+1)
                            i       = i + 1
                            !                   WRITE(700,*) 'iatom,ilo,igpt',iatom,ilo,igpt
                                  ...
                                  IF( atoms%invsat(iatom1) .EQ. 0 .OR. atoms%invsat(iatom1) .EQ. 1 ) THEN
                                     ...
                                     DO  ilo1 = 1,atoms%nlo(itype1)
                                        ...
                                        DO igpt1 = 1,invsfct1*(2*l1+1)
                                           ...
                                           IF( j .GT. i ) CYCLE
                                           !                             WRITE(700,*) 'iatom1,ilo1,igpt1',iatom1,ilo1,igpt1
                                           cdum = 0
                                           ic   = 0
                                           DO isym = 1,nsymop
                                              iop    = psym(isym)
                                              ...
                                              !                               WRITE(700,*) 'isym,ratom,ratom1',isym,ratom,ratom1
                                              ...
                                              !                               WRITE(700,*) 'igpt_lo1,igpt_lo2',igpt_lo1,igpt_lo2
                                              !                               WRITE(700,*) 'igpt1_lo1,igpt1_lo2',igpt1_lo1,igpt1_lo2
