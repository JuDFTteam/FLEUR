...
CONTAINS
  ...
  SUBROUTINE read_eig(id,nk,jspin,nv,nmat,bk,wk,neig,eig,w_iks,el,ello,evac,n_start,n_end,zmat)
    ...
    SELECT CASE (eig66_data_mode(id))
    CASE (DA_mode)
       CALL read_eig_DA(id,nk,jspin,nv,nmat,bk,wk,neig,eig,w_iks,el,ello,evac,n_start,n_end,zmat)
    CASE (hdf_mode)
       CALL read_eig_hdf(id,nk,jspin,nv,nmat,bk,wk,neig,eig,w_iks,el,ello,evac,n_start,n_end,zmat)
    CASE (mem_mode)
       CALL read_eig_mem(id,nk,jspin,nv,nmat,bk,wk,neig,eig,w_iks,el,ello,evac,n_start,n_end,zmat)
    CASE (mpi_mode)
       CALL read_eig_mpi(id,nk,jspin,nv,nmat,bk,wk,neig,eig,w_iks,el,ello,evac,n_start,n_end,zmat)
    CASE (-1)
  ...
  SUBROUTINE write_eig(id,nk,jspin,neig,neig_total,nv,nmat,bk,wk,eig,w_iks,el,ello,evac,nlotot,n_start,n_end,zmat)
    ...
    SELECT CASE (eig66_data_mode(id))
    CASE (da_mode)
       CALL write_eig_DA(id,nk,jspin,neig,neig_total,nv,nmat,bk,wk,eig,w_iks,el,ello,evac,nlotot,n_start,n_end,zmat)
    CASE (hdf_mode)
       CALL write_eig_HDF(id,nk,jspin,neig,neig_total,nv,nmat,bk,wk,eig,w_iks,el,ello,evac,nlotot,n_start,n_end,zmat)
    CASE (mem_mode)
       CALL write_eig_Mem(id,nk,jspin,neig,neig_total,nv,nmat,bk,wk,eig,w_iks,el,ello,evac,nlotot,n_start,n_end,zmat)
    CASE (MPI_mode)
       CALL write_eig_MPI(id,nk,jspin,neig,neig_total,nv,nmat,bk,wk,eig,w_iks,el,ello,evac,nlotot,n_start,n_end,zmat)
    CASE (-1)
