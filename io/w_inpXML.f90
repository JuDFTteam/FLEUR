...
160      FORMAT('      <nocoParams l_ss="', l1, '" l_mperp="', l1,'" l_mtNocoPot="', l1,'" l_alignMT="', l1, '" l_constr="', l1, &
                '" mix_b="', f0.8, '">')
         WRITE (fileNum, 160) noco%l_ss, noco%l_mperp, noco%l_mtNocoPot,noco%l_alignMT,noco%l_constr, noco%mix_b
