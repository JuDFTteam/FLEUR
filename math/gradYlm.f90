...
!$OMP parallel private(imesh) default(none) shared(lmOutput,iatom,mqn_mpp,pfac,tGaunt,oqn_l,lmInput,r2FshMtre,r2FshMtim,rDerFshMtim,rDerFshMtre,rDerFshMt,itype,r2GrFshMtNat,atoms,r2FshMt)
!$OMP do 
