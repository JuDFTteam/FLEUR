...
CONTAINS
  SUBROUTINE mpi_bc_all(&
    ...
    IF (mpi%irank.EQ.0) THEN
       ...
       r(19)=cell%volint ; r(20)=mpdata%g_cutoff ; r(21)=mpdata%linear_dep_tol ; r(22)=0.0
       ...
       l(46)=input%l_removeMagnetisationFromInterstitial; l(47)=input%ldauAdjEnpara ; l(48)=banddos%band
    ENDIF
    !
    ...
    atoms%nlotot=i(44)
    atoms%n_hia=i(46);atoms%n_gf=i(47)
    !
    ...
    cell%volint=r(19) ; mpdata%g_cutoff=r(20) ; mpdata%linear_dep_tol=r(21)
    ...
    noco%l_spav=l(15); input%ldauAdjEnpara=l(47); banddos%band=l(48)
    ...
    CALL MPI_BCAST(sym%ntypsy,atoms%nat,MPI_INTEGER,0,mpi%mpi_comm,ierr)
    ...
    CALL MPI_BCAST(sym%invsat,atoms%nat,MPI_INTEGER,0,mpi%mpi_comm,ierr)
    CALL MPI_BCAST(sym%invsatnr,atoms%nat,MPI_INTEGER,0,mpi%mpi_comm,ierr)
    CALL MPI_BCAST(sym%ngopr,atoms%nat,MPI_INTEGER,0,mpi%mpi_comm,ierr)
    ...
    CALL MPI_BCAST(atoms%lda_u(:)%phi,atoms%n_u+atoms%n_hia,MPI_DOUBLE_PRECISION,0,mpi%mpi_comm,ierr)
    CALL MPI_BCAST(atoms%lda_u(:)%theta,atoms%n_u+atoms%n_hia,MPI_DOUBLE_PRECISION,0,mpi%mpi_comm,ierr)
