...
MODULE m_types_matelements_soc
    ...
    TYPE, EXTENDS(t_matelements) :: t_matelements_soc
        ...
        TYPE(t_usdus),  POINTER :: usdus  => NULL()
...
CONTAINS
    ...
    subroutine init(this, atoms, noco, input, sym, cell, enpara, lapw, vtot, rsoc, usdus, fmpi, nococonv)
        ...
        TYPE(t_usdus),  TARGET, INTENT(IN) :: usdus
    ...
    subroutine add_matrix_elements(this, zmat, mat_inout)
      ...
      integer :: i, j, i1, j1, na, lm1, m1, i1_int, j1_int
        ...
        DO n = 1,this%atoms%ntype
         call radfun%generate_radial_functions(this%atoms, this%input, this%enpara, this%fmpi, this%vtot, n)
         ...
         call abc(1)%calc_abc(this%input, this%atoms, this%sym, this%cell, this%lapw, num_bands, this%usdus, this%noco, this%nococonv, 1, n, zMat(1))

         if (this%input%jspins == 2) then
            call abc(2)%init(this%input, this%atoms, radfun%n_r, num_bands, n)
            call abc(2)%calc_abc(this%input, this%atoms, this%sym, this%cell, this%lapw, num_bands, this%usdus, this%noco, this%nococonv, 2, n, zMat(2))
         else
            abc(2) = abc(1)
         end if
         DO j1=1,2
