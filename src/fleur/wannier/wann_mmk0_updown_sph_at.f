...
c**************************************************************
      ...
      complex           :: suma(atoms%nat),sumb(atoms%nat)
      complex           :: sumc(atoms%nat),sumd(atoms%nat)
      ...
      ci = cmplx(0.0,1.0)
      allocate (qlo(noccbd,noccbd,atoms%nlod,atoms%nlod,atoms%nat), 
     +          qaclo(noccbd,noccbd,atoms%nlod,atoms%nat),
     +          qbclo(noccbd,noccbd,atoms%nlod,atoms%nat) )
