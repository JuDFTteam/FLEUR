...
!--------------------------------------------------------------------------------
     ...
     &     bk,lapw,lapw_gf,enpara,vpw,vr,vs_mmp,tlmplm_DATA,raddata,            &
     &     pot_aux)                                                     
!*************************************************                      
...
!*************************************************                      
      ...
      TYPE(t_usdus),INTENT(INOUT)  :: raddata 
     ...
     &        l_writespectrum,nk,.false.)
      ...
      IF(layers%num_layers>1)THEN 
         ...
         !ALLOCATE( gij2(2*lapw_gf%nv2_tot,2*lapw_gf%nv2_tot,1) )
         !ALLOCATE( unity(lapw_gf%nv2_tot,lapw_gf%nv2_tot))
         !UNITY=0.0
         !DO en=1,lapw_gf%nv2_tot
         !  unity(en,en)=1.0
         !ENDDO
         !energy loop
         DO en = 1,gf_noen() 
     ...
     &           ,noco%l_noco,sym%invs,.false.,g,gij,real_energy=gfinp%l_CBS.or.gfinp%curr.ne.0)
            ...
            !gij(1:lapw_gf%nv2_tot,1:lapw_gf%nv2_tot,1)=gij(1:lapw_gf%nv2_tot,1:lapw_gf%nv2_tot,1)
            !gij(1:lapw_gf%nv2_tot,lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1)=gij2(1:lapw_gf%nv2_tot,lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1)
            !gij(lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1)=gij(lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1)
            !gij(lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1:lapw_gf%nv2_tot,1)=gij2(lapw_gf%nv2_tot+1:2*lapw_gf%nv2_tot,1:lapw_gf%nv2_tot,1)
