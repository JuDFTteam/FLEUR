...
MODULE m_make_crystal
  ...
  !********************************************************************
CONTAINS
  SUBROUTINE make_crystal(film,l_onlyIdentitySym, atomid,atompos,mag_mom,atomlabel,dvac,noco,&
       cell,sym,atoms)
    ...
    IMPLICIT NONE
    !===> Arguments
    LOGICAL, INTENT(IN)     :: film,l_onlyIdentitySym
    ...
    CALL make_spacegroup(film,l_onlyIdentitySym,noco,cell,atompos,atomid,mag_mom,sym)
