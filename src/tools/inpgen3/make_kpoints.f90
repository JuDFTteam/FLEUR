...
CONTAINS
  SUBROUTINE make_kpoints(kpts,cell,sym,film,l_socorss,bz_integration,l_gamma_in,str,kptsName,kptsPath,l_onlyIdentitySym)
    USE m_types_kpts
    USE m_types_cell
    USE m_types_sym
    USE m_kpts_kplib
