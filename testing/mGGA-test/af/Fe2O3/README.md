...
- **SCAN (Tran et al. 2020, Table VI), Bader spin moment on Fe: 4.01 muB**
- Experiment (total mu_S + mu_L): 4.17 / 4.22 (footnotes n,o)
- **Comparison quantity in FLEUR: use the muffin-tin projected spin
  magnetic moment on the Fe atom** (per your instruction), not a
  Bader-volume moment -- FLEUR reports this directly per atom type in
  `out.xml`. Expect a systematic offset from the 4.01 muB target
