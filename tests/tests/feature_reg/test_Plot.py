...
def test_PlotDenandPot(execute_fleur, grep_number, grep_exists):
    ...
    assert grep_exists(res_files['denIn_A2.xsf'], "1.55851") #line 19: 1.5585126056320757E-002
    assert grep_exists(res_files['denIn_A2.xsf'], "0.12627") #line 373: 0.12627294308505568
    assert grep_exists(res_files['denIn_A2.xsf'], "0.12725") #line 363: 0.12725278698501802
    ...
    assert grep_exists(res_files['vTot_f.xsf'], "10.44663")   #line 20: -10.446631929661454
    assert grep_exists(res_files['vTot_f.xsf'], "4.62361")    #line 129: -4.6236187702542262
    ...
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "0.015585") #line 101 second value: 0.01558512606
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "0.42575")  #line 102 second value: 0.42575826806
    ...
    assert grep_exists(res_files['vTot_A_vec_plot.xsf'], "0.029060") #line 291 third value: -0.02906010287
...
def test_PlotOnlyMT(execute_fleur, grep_number, grep_exists):
    ...
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "0.318444") #line 21 second coordinate: 0.31844444444
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "0.015585") #line 101 second value: 0.01558512606
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "0.425758") #line 102 second value: 0.42575826806
    assert grep_exists(res_files['denIn_A_vec_plot.xsf'], "2.547555") #line 109 first coordinate: 2.54755555556
