...
CONTAINS
   ...
   CALL mt_to_grid(.TRUE., jspins, atoms, sym,sphhar, xcB(1)%mt(:,0:,n,:), n, gradx)
   CALL mt_to_grid(.TRUE., jspins, atoms, sym,sphhar, xcB(2)%mt(:,0:,n,:), n, grady)
   CALL mt_to_grid(.TRUE., jspins, atoms, sym,sphhar, xcB(3)%mt(:,0:,n,:), n, gradz)
