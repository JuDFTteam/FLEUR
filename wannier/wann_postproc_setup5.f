...
c******************************************************
c     Call the Wannier90 5d setup routine.
...
c******************************************************
      ...
      real,    intent(in)         :: kpoints(5,nkpts)
      real,    intent(in)         :: amat(5,5)
      real,    intent(in)         :: bmat(5,5)
      integer, intent(in)         :: num(5)
      ...
      interface
        subroutine wannier_setup5(seed__name, mp_grid_loc,
     +    num_kpts_loc,
     ...
     +      nnlist_loc
         integer,dimension(5,num_kpts_loc,num_nnmax), intent(out) ::
     +      nncell_loc
...
c******************************************************
      ...
      do ikpt=1,nkpts
        do nn=1,nntot
          write (202,'(2i6,3x,5i4)') 
c     &     ikpt,bpt(nn,ikpt),(gb(i,nn,ikpt),i=1,3)
     &     ikpt,nnlist(ikpt,nn),(nncell(i,ikpt,nn),i=1,5)
        enddo
      enddo
      close(202)
